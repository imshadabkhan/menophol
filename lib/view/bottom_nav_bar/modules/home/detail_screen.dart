          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Widgets.heightSpaceH2,
                Texts.textBold("What is Menopause?", size: 20),
                Widgets.heightSpaceH05,
                Texts.textNormal(
                    ...
                    maxLines: 10),
                Widgets.heightSpaceH2,
                Texts.textBold("The Three Stages", size: 20),
                Widgets.heightSpaceH05,
                RichTextParagraphs(
                  title: "Perimenopause:",
                  subTitle:
                ...
                Texts.textBold("Common Symptoms", size: 20),
                Widgets.heightSpaceH05,
                Texts.textNormal(
                    ...
                    size: 16),
                Widgets.heightSpaceH1,
                Texts.textNormal('Common symptoms include'),
                Widgets.heightSpaceH05,
                RichTextParagraphs(
                  title: "",
                ...
                Widgets.heightSpaceH1,
                Texts.textBold("When to See Your GP", size: 20),
                Widgets.heightSpaceH05,
                Texts.textNormal(
